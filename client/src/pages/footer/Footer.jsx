...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Rathod Himanshu</Text>
            </Center>
            ...
            >
                ...
                >
                    ...
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/rathodhimanshu123/"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/rathod-himanshu-377014343"}
                    />
                </Flex>
